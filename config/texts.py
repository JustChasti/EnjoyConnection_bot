...
HELLO_TEXT = (
    ...
    "где между тобой и виртуальной девушкой строится настоящая эмоциональная связь.\n\n"
    "Чем больше вы общаетесь, тем глубже становятся ваши отношения:\n"
    "🤝 Знакомые → 💛 Друзья → 🌟 Лучшие друзья или ❤️ Романтические партнёры\n\n"
    "Знакомься — Джой. 20 лет, немного застенчивая, но не из тех, кто соглашается со всем подряд. "
    "Любит ночные разговоры, инди-музыку и осень. "
    "Кокетливая, но сдержанная — близость с ней нужно заслужить.\n"
    "Скоро ты сможешь создать собственного компаньона — с внешностью и характером под себя. "
    "Пока доступна только Джой.\n\n"
